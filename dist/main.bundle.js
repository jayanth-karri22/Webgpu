...
const CheckWebGPU = () => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        try {
            const { device } = yield (0,_helper__WEBPACK_IMPORTED_MODULE_1__.CheckWebGPU)();
            const canvas = document.getElementById("canvas-webgpu");
            const context = canvas === null || canvas === void 0 ? void 0 : canvas.getContext('webgpu');
            const presentationFormat = (_a = navigator === null || navigator === void 0 ? void 0 : navigator.gpu) === null || _a === void 0 ? void 0 : _a.getPreferredCanvasFormat();
            ...
            const module = device.createShaderModule({
                ...
                code: _shaders__WEBPACK_IMPORTED_MODULE_2__.shaders
            });
            ...
            const render = () => {
                renderPassDescriptor.colorAttachments[0].view = context === null || context === void 0 ? void 0 : context.getCurrentTexture().createView();
            ...
            console.error(error);
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("body").append(`<h1>${error}</h1>`);
        }
    });
}
main();
